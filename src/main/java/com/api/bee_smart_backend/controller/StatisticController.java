...
public class StatisticController {
    ...
    public ResponseEntity<ResponseObject<Map<String, Map<String, Double>>>> getBattleAverageByMonth(
            @RequestParam(required = false) String date,
            @RequestParam(name = "subject", required = false) String subject) {
        try {
            Map<String, Map<String, Double>> chartData = statisticService.getBattleAveragePointsByMonth(date, subject);
            return ResponseEntity.status(HttpStatus.OK)
